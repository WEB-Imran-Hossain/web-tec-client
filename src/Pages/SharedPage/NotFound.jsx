...
const NotFound = () => {
  return (
    <div className="text-center font-bold text-[#1D2833] flex flex-col justify-center items-center h-screen space-y-5">
      ...
      <Link to="/">
        <button className="btn hover:bg-transparent text-white bg-[#7EBC12] border-[#7EBC12] hover:bg-[#1D2833] hover:border-[#1D2833] hover:text-white text-lg font-semibold rounded-none normal-case ">
          Back to Home
        </button>
      </Link>
    </div>
